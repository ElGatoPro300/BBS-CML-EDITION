...
public class ReplayKeyframes extends ValueGroup
{
    ...
    public void record(int tick, IEntity entity, List<String> groups)
    {
        ...
        this.activeHand.insert(tick, entity.getActiveHand() == net.minecraft.util.Hand.OFF_HAND ? 1D : 0D);
    ...
    public void apply(int tick, IEntity entity, List<String> groups)
    {
        ...
        entity.setActiveHand(this.activeHand.interpolate(tick) > 0D ? net.minecraft.util.Hand.OFF_HAND : net.minecraft.util.Hand.MAIN_HAND);
