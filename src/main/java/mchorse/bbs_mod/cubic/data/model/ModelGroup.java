...
public class ModelGroup implements IMapSerializable
{
    ...
    public Color colorWrap = new Color().set(1F, 1F, 1F);
    ...
    public ModelGroup copy(Model newOwner, ModelGroup newParent)
    {
        ...
        group.colorWrap.copy(this.colorWrap);
        group.colorWrapOpacity = this.colorWrapOpacity;
