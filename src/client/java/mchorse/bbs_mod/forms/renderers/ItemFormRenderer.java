...
public class ItemFormRenderer extends FormRenderer<ItemForm>
{
    ...
    public void renderInUI(UIContext context, int x1, int y1, int x2, int y2)
    {
        ...
        // MinecraftClient.getInstance().getItemRenderer().renderItem(ItemDisplayContext.GROUND, this.form.stack.get(), LightmapTextureManager.MAX_BLOCK_LIGHT_COORDINATE, OverlayTexture.DEFAULT_UV, matrices, consumers, MinecraftClient.getInstance().world, 0);
        consumers.draw();
    ...
    protected void render3D(FormRenderingContext context)
    {
        ...
        // MinecraftClient.getInstance().getItemRenderer().renderItem(mode, this.form.stack.get(), light, context.overlay, context.stack, consumers, context.entity.getWorld(), 0);
        consumers.draw();
        consumers.setSubstitute(null);
