...
public class ModelVAORenderer
{
    ...
    public static void setTextureBlend(mchorse.bbs_mod.resources.Link toTexture, float blend)
    {
    ...
    public static void render(ShaderProgram shader, IModelVAO modelVAO, MatrixStack stack, float r, float g, float b, float a, int light, int overlay)
    {
        ...
        {
            mchorse.bbs_mod.BBSModClient.getTextures().bindTexture(ModelVAORenderer.textureBlendTo, 3);
        }
