...
public class FormRenderDepth
{
    ...
    public static List<Occluder> collectOccluders(IntObjectMap<IEntity> entities, Camera camera, float transition, java.util.function.Function<Integer, Form> sourceFormProvider)
    {
        return collectOccluders(entities, camera.position.x, camera.position.y, camera.position.z, transition, sourceFormProvider);
    }

    public static List<Occluder> collectOccluders(IntObjectMap<IEntity> entities, net.minecraft.client.render.Camera camera, float transition, java.util.function.Function<Integer, Form> sourceFormProvider)
    {
    ...
    private static List<Occluder> collectOccluders(IntObjectMap<IEntity> entities, double cameraX, double cameraY, double cameraZ, float transition, java.util.function.Function<Integer, Form> sourceFormProvider)
    {
